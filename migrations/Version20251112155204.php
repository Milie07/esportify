...
final class Version20251112155204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tournament_images (tournament_image_id INT UNSIGNED AUTO_INCREMENT NOT NULL, image_url VARCHAR(255) DEFAULT NULL, PRIMARY KEY(tournament_image_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
